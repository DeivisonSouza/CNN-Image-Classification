...
#' Description: The dataset used in this code was used by Souza et al. (2020) in the manuscript "An automatic recognition system of Brazilian flora species based on textural features of macroscopic images of wood". The data described in this study is available at Mendeley Data (DOI: 10.17632/cc78ftcdf9.1).
#---------------------------------------------------------------------------
